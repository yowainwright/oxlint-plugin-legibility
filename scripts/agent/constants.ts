...
export const agentSkillName = "oxlint-plugin-legibility";
export const agentSkillTitle = "Oxlint Plugin Legibility";
...
const descriptionTool = "with oxlint-plugin-legibility, fixing legibility diagnostics,";
...
const purposeHeading = "# Oxlint Plugin Legibility";
const purposeBody =
